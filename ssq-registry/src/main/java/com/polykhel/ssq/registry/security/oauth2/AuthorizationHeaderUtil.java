...
public class AuthorizationHeaderUtil {
    ...
    private OAuth2AccessTokenResponse refreshTokenClient(OAuth2AuthorizedClient currentClient) {
        ...
        formParameters.add(OAuth2ParameterNames.REFRESH_TOKEN, currentClient.getRefreshToken() != null ? currentClient.getRefreshToken().getTokenValue() : "");
    ...
    private OAuth2AccessTokenResponse toOAuth2AccessTokenResponse(@Nullable OAuthIdpTokenResponseDTO oAuthIdpResponse) {
        if (oAuthIdpResponse != null) {
