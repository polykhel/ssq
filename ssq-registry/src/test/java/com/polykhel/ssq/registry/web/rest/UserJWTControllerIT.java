...
import com.polykhel.ssq.registry.web.rest.errors.ExceptionTranslator;
import com.polykhel.ssq.web.rest.vm.LoginVM;
...
@SpringBootTest(classes = SsqRegistryApp.class)
