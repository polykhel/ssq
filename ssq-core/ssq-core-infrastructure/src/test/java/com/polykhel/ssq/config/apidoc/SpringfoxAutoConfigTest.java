...
@SpringBootTest(
        classes = SpringfoxAutoConfigTest.TestApp.class,
        properties = {
...
public class SpringfoxAutoConfigTest {
    ...
    @SpringBootApplication(
            scanBasePackages = "com.polykhel.ssq.config.apidoc",
            exclude = {
    ...
    @ConfigurationPropertiesScan("com.polykhel.ssq.config")
    @Controller
