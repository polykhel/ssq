 ...
 * <p>
 * {@code
 * com.polykhel.ssq.test.LogbackRecorder recorder = com.polykhel.ssq.test.LogbackRecorder.forClass(TestedClass.class)
 * .reset()
 * .capture(Level.WARN.name());
 * // do something that logs
 * List<com.polykhel.ssq.test.LogbackRecorder.Event> events = recorder.release().play();
